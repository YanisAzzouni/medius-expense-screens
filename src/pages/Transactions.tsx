...
const TRANSACTIONS: Transaction[] = [
  { id: "1", merchant: "Pet Paradise",     source: "BNPP - France", employee: "Ava Thompson",    txDate: "Feb 22, 2026", txDateIso: "2026-02-22", amount: "450.75", expState: "To review", category: "misc"           },
  { id: "2", merchant: "Gourmet Bistro",   source: "BNPP - France", employee: "Michael Brown",   txDate: "Jan 15, 2026", txDateIso: "2026-01-15", amount: "675.20", expState: "To review", category: "meals"          },
  { id: "3", merchant: "Tech Haven",       source: "BNPP - France", employee: "Emily Johnson",   txDate: "Jun 18, 2026", txDateIso: "2026-06-18", amount: "720.30", expState: "To review", category: "equipment"      },
  { id: "4", merchant: "Bookworm's Nook",  source: "Medius card",   employee: "Sophia Davis",    txDate: "May 12, 2026", txDateIso: "2026-05-12", amount: "560.45", expState: "To submit", category: "misc"           },
  { id: "5", merchant: "Fashion Hub",      source: "Medius card",   employee: "Olivia Taylor",   txDate: "Mar 30, 2026", txDateIso: "2026-03-30", amount: "390.10", expState: "To submit", category: "misc"           },
  { id: "6", merchant: "GreenGrocer",      source: "Medius card",   employee: "James Anderson",  txDate: "Jul 24, 2026", txDateIso: "2026-07-24", amount: "880.60", expState: "Approved",  category: "meals"          },
  { id: "7", merchant: "Fitness World",    source: "Medius card",   employee: "Juliette Martin", txDate: "Sep 7, 2026",  txDateIso: "2026-09-07", amount: "820.50", expState: "Approved",  category: "misc"           },
  { id: "8", merchant: "Travel Explorers", source: "Import",        employee: "Liam Wilson",     txDate: "Apr 5, 2026",  txDateIso: "2026-04-05", amount: "540.90", expState: "Approved",  category: "transportation" },
  { id: "9", merchant: "Home Essentials",  source: "Import",        employee: "John Smith",      txDate: "Aug 31, 2026", txDateIso: "2026-08-31", amount: "610.15", expState: "Approved",  category: "misc"           },
];
...
const COLUMNS: ColumnDef[] = [
  ...
  { key: "merchant", type: "text",    title: "Merchant name", fill: true },
...
export default function Transactions() {
  ...
  const rows: RowData[] = TRANSACTIONS.map((tx) => ({
    ...
    expState: { label: tx.expState, variant: EXP_STATE_VARIANT[tx.expState] } satisfies StatusCellData,
    actions:  {
